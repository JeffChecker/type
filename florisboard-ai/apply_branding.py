...
for rel in ["values/strings.xml", "values-de/strings.xml"]:
    ...
    attribution = '    <string name="ki_tastatur__based_on_florisboard">Basierend auf FlorisBoard v0.5.2 • Apache 2.0</string>\n'
...
print("Visible branding changed to KI Tastatur; FlorisBoard kept only as attribution/source reference")
